...
This plan has been superseded by the Phase 7 implementation recorded in `docs/PHASE_7_CHANGES.md` and the workspace hardening pass recorded in `docs/CHANGE_LOG.md`. Keep this file as planning context only; use `docs/REMAINING_WORK.md` for the current backlog.
